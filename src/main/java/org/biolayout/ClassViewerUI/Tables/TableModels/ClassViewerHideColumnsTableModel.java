...
*
* @see org.biolayout.ClassViewerUI.Dialogs.ClassViewerHideColumnsDialog
    ...
    public void updateClassViewerHideColumnsTable(ClassViewerFrame classViewerFrame, boolean enableHideColumnsAndExportButtons, boolean updateCorrelationGraphViewOnly, boolean notUpdateTitleBar)
    {
        if (enableHideColumnsAndExportButtons)
        {
            ...
            else
            {
                ...
                classViewerFrame.populateClassViewer(data, updateCorrelationGraphViewOnly, notUpdateTitleBar, false);
            }
        }
        else
            data = new Object[0][0];

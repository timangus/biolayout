package org.biolayout.Environment;
...
import org.biolayout.BuildConfig;
...
public final class GlobalEnvironment
{
    ...
    private static final String LOGO_NAME = IMAGE_FILES_PATH + DEFAULT_SURFACE_IMAGE_FILES[0] + ".png";
    public static final BufferedImage LOGO_IMAGE = loadImageFromURL( GlobalEnvironment.class.getResource(LOGO_NAME) );

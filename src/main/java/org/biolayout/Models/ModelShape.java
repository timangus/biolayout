...
import org.biolayout.CPUParallelism.*;
...
*
* @see org.biolayout.Models.ModelSettings
* @see org.biolayout.Models.ModelRenderingStates
* @see org.biolayout.Models.Lathe3D.Lathe3DShape
* @see org.biolayout.Models.SuperQuadric.SuperQuadricShape
* @see org.biolayout.Models.Loaders.OBJModelLoader.OBJModelLoader
    ...
    */
    public void saveModelShapeOBJFile(FileWriter fileWriter, ModelTypes modelShapeType) throws IOException
    {
        if ( !modelShapeType.equals(OBJ_MODEL_LOADER_SHAPE) )
        {
            ...
            fileWriter.write("# Generated by " + VERSION + " (" + DOMAIN_URL + ") from Model Shape Editor: " + fileType + "\n");
            fileWriter.write("\n");

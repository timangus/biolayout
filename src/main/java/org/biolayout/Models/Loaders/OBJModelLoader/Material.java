...
*
* @author Andrew Davison, 2006, rewrite by Thanos Theo, 2011
* @version 3.0.0.0
*
*/
...
public class Material
{
    ...
    */
    ...
    {
        texture = TextureProducer.createTextureFromBufferedImageAndDeleteOrigContext(org.biolayout.StaticLibraries.ImageProducer.loadImageFromURL( getClass().getResource(textureFileName) ), true);
    }

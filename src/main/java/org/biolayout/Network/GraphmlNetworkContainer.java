...
import static org.biolayout.Network.GraphmlLookUpmEPNTables.*;
...
public class GraphmlNetworkContainer
{
    ...
    private HashMap<String, org.biolayout.DataStructures.Stack<float[]>> allUndoGraphmlMapCoordsStacksMap = null;
    private HashMap<String, org.biolayout.DataStructures.Stack<float[]>> allRedoGraphmlMapCoordsStacksMap = null;
    ...
    */
    public boolean isEmptyUndoPointStack(GraphNode node)
    {
        ...
        {
            org.biolayout.DataStructures.Stack<float[]> undoGraphmlMapCoordsStack = allUndoGraphmlMapCoordsStacksMap.get( node.getNodeName() );
    ...
    */
    public boolean isEmptyRedoPointStack(GraphNode node)
    {
        ...
        {
            org.biolayout.DataStructures.Stack<float[]> redoGraphmlMapCoordsStack = allRedoGraphmlMapCoordsStacksMap.get( node.getNodeName() );
    ...
    */
    ...
    {
        if (allUndoGraphmlMapCoordsStacksMap == null)
            allUndoGraphmlMapCoordsStacksMap = new HashMap<String, org.biolayout.DataStructures.Stack<float[]>>();
        org.biolayout.DataStructures.Stack<float[]> undoGraphmlMapCoordsStack = allUndoGraphmlMapCoordsStacksMap.get( node.getNodeName() );

        if (undoGraphmlMapCoordsStack == null)
        {
            undoGraphmlMapCoordsStack = new org.biolayout.DataStructures.Stack<float[]>(USE_LINKEDLIST);
    ...
    */
    ...
    {
        if (allRedoGraphmlMapCoordsStacksMap == null)
            allRedoGraphmlMapCoordsStacksMap = new HashMap<String, org.biolayout.DataStructures.Stack<float[]>>();
        org.biolayout.DataStructures.Stack<float[]> redoGraphmlMapCoordsStack = allRedoGraphmlMapCoordsStacksMap.get( node.getNodeName() );

        if (redoGraphmlMapCoordsStack == null)
        {
            redoGraphmlMapCoordsStack = new org.biolayout.DataStructures.Stack<float[]>(USE_LINKEDLIST);

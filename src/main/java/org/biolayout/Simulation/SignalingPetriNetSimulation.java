package org.biolayout.Simulation;
...
*
* @see org.biolayout.Simulation.Dialogs.SignalingPetriNetSimulationDialog
...
public class SignalingPetriNetSimulation
{
    ...
    */
    private double computeProbability()
    {
        ...
        {
            double randomValue = org.biolayout.StaticLibraries.Random.nextGaussian();

...
import static org.biolayout.Simulation.SignalingPetriNetSimulation.*;
...
*
* @see org.biolayout.Simulation.SignalingPetriNetSimulation
    ...
    */
    private void loadSignalingPetriNetSimulationFile(File file)
    {
        ...
        else
        {
            ...
            {
                JOptionPane.showMessageDialog(layoutFrame, "Not supported " + PRODUCT_NAME + " import file type!\n" + fileFilter.getDescription(),

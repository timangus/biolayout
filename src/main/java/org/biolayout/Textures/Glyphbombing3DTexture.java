...
public final class Glyphbombing3DTexture
{
    ...
    */
    public void initGlyphbombing3DTexture(GL2 gl, int textureUnit)
    {
        ...
        BufferedImage glyphImage = org.biolayout.StaticLibraries.ImageProducer.cloneImage( texturesLoader.getImage(GLYPH_TEXTURE_NAME) );
        readPixels( org.biolayout.StaticLibraries.ImageProducer.resizeImageByGivenRatio(glyphImage, (currentTexture2DSliceSize / (float)MAX_TEXTURE_2D_SLICE_SIZE), true) );

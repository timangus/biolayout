...
import static org.biolayout.Textures.ImageSFXsCollateStates.*;
...
*
* @see org.biolayout.Graph.GraphRenderer2D
...
public class ImageSFXs
{
    ...
    */
    public static BufferedImage createCollatedImage(BufferedImage image1, BufferedImage image2, ImageSFXsCollateStates collateState, float resizeRatio, boolean qualityRendering)
    {
        if (image1 == null || image2 == null)
        {
            ...
            return org.biolayout.StaticLibraries.ImageProducer.createNullPointerBufferedImage();
        }

        image1 = org.biolayout.StaticLibraries.ImageProducer.resizeImageByGivenRatio(image1, resizeRatio, qualityRendering);
        image2 = org.biolayout.StaticLibraries.ImageProducer.resizeImageByGivenRatio(image2, resizeRatio, qualityRendering);
        ...
        int imageMaxWidth = org.biolayout.StaticLibraries.Math.findMinMaxFromNumbers(image1Width, image2Width, false);
        int imageMaxHeight = org.biolayout.StaticLibraries.Math.findMinMaxFromNumbers(image1Height, image2Height, false);
        ...
        if ( collateState.equals(COLLATE_NORTH) )
        {
           ...
           org.biolayout.StaticLibraries.ImageProducer.useQuality(tempImageGC, qualityRendering);
    ...
    */
    public void plasmaEffectInit(int plasmaEffectWidth, int plasmaEffectHeight)
    {
        ...
        plasmaBitmapImage = org.biolayout.StaticLibraries.ImageProducer.cloneAndBufferImage(plasmaBitmapImage); // somehow, the Java API does a faster acceleration after using this method (using a predefined transparency and copying it)
    ...
    */
    private void waterEffectInit(BufferedImage waterEffectBitmapImage)
    {
        if (waterEffectBitmapImage == null)
        {
            ...
            waterBitmapImage = org.biolayout.StaticLibraries.ImageProducer.cloneImage(waterBitmapImage);
            waterBitmapImage.setRGB(0, 0, 64, 64, waterBitmapBuffer, 0, 64);
        }
        else
        {
            waterBitmapBuffer = new int[waterWidth * waterHeight];
            waterBitmapImage = org.biolayout.StaticLibraries.ImageProducer.cloneImage(waterEffectBitmapImage);
    ...
    */
    private void bumpEffectInit(int bumpLightWidth, int bumpLightHeight, int bumpLightValue, int lightValue, int darkValue, BufferedImage bumpBitmapEffectImage)
    {
        if (bumpBitmapEffectImage == null)
        {
            ...
            bumpBitmapImage = org.biolayout.StaticLibraries.ImageProducer.cloneImage(bumpBitmapImage);
        ...
        else
        {
            ...
            bumpBitmapImage = org.biolayout.StaticLibraries.ImageProducer.cloneImage(bumpBitmapEffectImage);
        ...
        if (USE_MULTICORE_PROCESS)
            bumpBitmapImageToReturn = org.biolayout.StaticLibraries.ImageProducer.cloneImage(bumpBitmapImage);
    ...
    */
    private void radialBlurEffectInit(double radialBlurShortness, BufferedImage radialBlurEffectBitmapImage)
    {
        ...
        if (radialBlurEffectBitmapImage == null)
        {
            ...
            radialBlurBitmapImage = org.biolayout.StaticLibraries.ImageProducer.cloneImage(radialBlurBitmapImage);
        ...
        else
        {
            ...
            radialBlurBitmapImage = org.biolayout.StaticLibraries.ImageProducer.cloneImage(radialBlurEffectBitmapImage); // somehow, the Java API does a faster acceleration after using this method (using a predefined transparency and copying it)
        ...
        if (USE_MULTICORE_PROCESS)
            radialBlurBitmapImageToReturn = org.biolayout.StaticLibraries.ImageProducer.cloneImage(radialBlurBitmapImage);
    ...
    */
    public void spotCircleEffectInit(int spotCircleWidth, int spotCircleHeight, int spotCircleCenterX, int spotCircleCenterY, int distStep, boolean withNoiseEffect, int distRatio)
    {
        ...
        distMAX = org.biolayout.StaticLibraries.Math.findMinMaxFromNumbers(distMaxCornerTopLeft, distMaxCornerTopRight, distMaxCornerBottomLeft, distMaxCornerBottomRight, false); // false for MAX distance!

...
import static org.biolayout.Textures.ShaderTextureSFXs.*;
...
public class ShaderLightingSFXs
{
    ...
    */
    private void useProgramAndUniforms(GL2 gl, int effectIndex, boolean useTexturing, boolean useSphericalMapping, boolean useEmbossLogoName, boolean useFog, float morphingValue, boolean useUserClipping, boolean useAntiAlias, boolean state, boolean oldLCDStyleTransparency, boolean erosion, boolean shrinkTriangles, boolean solidWireFrame, boolean normals, float px, float py)
    {
        ...
        gl.glUniform1i(SHADER_PROGRAM_EMBOSS_NODE_TEXTURES[effectIndex], (useEmbossLogoName) ? 1 : 0);
    ...
    */
    ...
    {
        useProgramAndUniforms(gl, effectIndex, useTexturing, useSphericalMapping, useEmbossLogoName, useFog, morphingValue, useUserClipping, useAntiAlias, state, oldLCDStyleTransparency, erosion, shrinkTriangles, solidWireFrame, normals, px, py);
    ...
    */
    public void useShaderLightingSFX(GL2 gl, ShaderTypes shaderType, boolean useTexturing, boolean useSphericalMapping, boolean useEmbossLogoName, boolean useFog, float morphingValue, boolean useUserClipping, boolean useAntiAlias, boolean state, boolean oldLCDStyleTransparency, boolean erosion, boolean shrinkTriangles, boolean solidWireFrame, boolean normals, float px, float py)
    {
        useProgramAndUniforms(gl, shaderType.ordinal(), useTexturing, useSphericalMapping, useEmbossLogoName, useFog, morphingValue, useUserClipping, useAntiAlias, state, oldLCDStyleTransparency, erosion, shrinkTriangles, solidWireFrame, normals, px, py);
    }

package org.biolayout.StaticLibraries;
    ...
    */
    public static Texture getNullPointerTexture(boolean useAutoMipmapGeneration)
    {
        if (nullPointerTexture == null)
            nullPointerTexture = createTextureFromBufferedImage(org.biolayout.StaticLibraries.ImageProducer.createNullPointerBufferedImage(), useAutoMipmapGeneration);

...
final class GraphRenderer2DFinalVariables // package access
{
    ...
    *  Constant value needed for the 2D OpenGL renderer.
    */
    static final BufferedImage LOGO_IMAGE_WITH_BORDERS = createBufferedImageWithTransparentBorders(LOGO_IMAGE, (int)( 1.3f * LOGO_IMAGE.getWidth() ), (int)( 1.3f * LOGO_IMAGE.getHeight() ) );

package org.biolayout.Graph.GraphElements;
...
public class GraphNode implements Comparable<GraphNode>
{
    ...
    private org.biolayout.DataStructures.Stack<Point3D> undoPointStack = null;
    private org.biolayout.DataStructures.Stack<Point3D> redoPointStack = null;
    ...
    public void pushLocationInUndoPointStack()
    {
        if (undoPointStack == null)
            undoPointStack = new org.biolayout.DataStructures.Stack<Point3D>(USE_LINKEDLIST);
    ...
    public void pushLocationInRedoPointStack()
    {
        if (redoPointStack == null)
            redoPointStack = new org.biolayout.DataStructures.Stack<Point3D>(USE_LINKEDLIST);

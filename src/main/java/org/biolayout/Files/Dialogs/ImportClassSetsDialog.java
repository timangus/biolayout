package org.biolayout.Files.Dialogs;
...
*
* @see org.biolayout.Files.Dialogs.ImportSelectClassSetsDialog
...
public final class ImportClassSetsDialog extends JDialog implements ActionListener, CaretListener
{
    ...
    */
    ...
    private boolean checkSelectedDelimiterForRegularExpressionCompatibility()
    {
        ...
        {
            if (DEBUG_BUILD) org.biolayout.DebugConsole.ConsoleOutput.println("PatternSyntaxException in checkSelectedDelimiterForRegularExpressionCompatibility():\n" + exc.getMessage());
    ...
    */
    ...
    /**
    *  ImportClassSetsDialogListener interface, used as a callback design pattern for the framework.
    */

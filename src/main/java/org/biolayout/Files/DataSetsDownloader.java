...
import java.util.*;
import org.biolayout.Connections.*;
...
/**
*
* DataSetsDownloader is the data sets downloader class used to download the data sets from the server.
*
    ...
    */
    public boolean retrieveDataSetsControlFileDataFromRepository()
    {
        try
        {
            ...
            {
                int chooseRandomDataSetToLoad = org.biolayout.StaticLibraries.Random.getRandomRange( 1, dataSetsControlFileData.size() );
        ...
        {
            if (DEBUG_BUILD) println("Exception in retrieveDataSetsControlFileDataFromRepository() method:\n" + exc.getMessage());
        }

package org.Kajeka.Clustering.MCL;
...
final class MCLWindowDialog extends JDialog implements Runnable, ActionListener // package access
{
    ...
    */
    ...
    private static final int[] COLOR_PRIME_NUMBERS = org.Kajeka.StaticLibraries.Math.findPrimeNumbersUpToThreshold(COLOR_UPPER_RANGE);

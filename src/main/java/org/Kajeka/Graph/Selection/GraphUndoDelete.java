package org.Kajeka.Graph.Selection;
...
final class GraphUndoDelete // package access
{
    ...
    private org.Kajeka.DataStructures.Stack<HashSet<Vertex>> nodeSelectedNodesStack = null;
    private org.Kajeka.DataStructures.Stack<HashSet<Edge>> nodeSelectedEdgesStack = null;
    ...
    public GraphUndoDelete(SelectionManager selectionManager)
    {
        ...
        nodeSelectedNodesStack = new org.Kajeka.DataStructures.Stack<HashSet<Vertex>>(USE_LINKEDLIST);
        nodeSelectedEdgesStack = new org.Kajeka.DataStructures.Stack<HashSet<Edge>>(USE_LINKEDLIST);
    }

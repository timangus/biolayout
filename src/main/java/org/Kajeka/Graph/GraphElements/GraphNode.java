package org.Kajeka.Graph.GraphElements;
...
public class GraphNode implements Comparable<GraphNode>
{
    ...
    private org.Kajeka.DataStructures.Stack<Point3D> undoPointStack = null;
    private org.Kajeka.DataStructures.Stack<Point3D> redoPointStack = null;
    ...
    public void pushLocationInUndoPointStack()
    {
        if (undoPointStack == null)
            undoPointStack = new org.Kajeka.DataStructures.Stack<Point3D>(USE_LINKEDLIST);
    ...
    public void pushLocationInRedoPointStack()
    {
        if (redoPointStack == null)
            redoPointStack = new org.Kajeka.DataStructures.Stack<Point3D>(USE_LINKEDLIST);

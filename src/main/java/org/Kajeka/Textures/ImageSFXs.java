...
import static org.Kajeka.Textures.ImageSFXsCollateStates.*;
...
*
* @see org.Kajeka.Graph.GraphRenderer2D
...
public class ImageSFXs
{
    ...
    */
    public static BufferedImage createCollatedImage(BufferedImage image1, BufferedImage image2, ImageSFXsCollateStates collateState, float resizeRatio, boolean qualityRendering)
    {
        if (image1 == null || image2 == null)
        {
            ...
            return org.Kajeka.StaticLibraries.ImageProducer.createNullPointerBufferedImage();
        }

        image1 = org.Kajeka.StaticLibraries.ImageProducer.resizeImageByGivenRatio(image1, resizeRatio, qualityRendering);
        image2 = org.Kajeka.StaticLibraries.ImageProducer.resizeImageByGivenRatio(image2, resizeRatio, qualityRendering);
        ...
        int imageMaxWidth = org.Kajeka.StaticLibraries.Math.findMinMaxFromNumbers(image1Width, image2Width, false);
        int imageMaxHeight = org.Kajeka.StaticLibraries.Math.findMinMaxFromNumbers(image1Height, image2Height, false);
        ...
        if ( collateState.equals(COLLATE_NORTH) )
        {
           ...
           org.Kajeka.StaticLibraries.ImageProducer.useQuality(tempImageGC, qualityRendering);
    ...
    */
    public void plasmaEffectInit(int plasmaEffectWidth, int plasmaEffectHeight)
    {
        ...
        plasmaBitmapImage = org.Kajeka.StaticLibraries.ImageProducer.cloneAndBufferImage(plasmaBitmapImage); // somehow, the Java API does a faster acceleration after using this method (using a predefined transparency and copying it)
    ...
    */
    private void waterEffectInit(BufferedImage waterEffectBitmapImage)
    {
        if (waterEffectBitmapImage == null)
        {
            ...
            waterBitmapImage = org.Kajeka.StaticLibraries.ImageProducer.cloneImage(waterBitmapImage);
            waterBitmapImage.setRGB(0, 0, 64, 64, waterBitmapBuffer, 0, 64);
        }
        else
        {
            waterBitmapBuffer = new int[waterWidth * waterHeight];
            waterBitmapImage = org.Kajeka.StaticLibraries.ImageProducer.cloneImage(waterEffectBitmapImage);
    ...
    */
    private void bumpEffectInit(int bumpLightWidth, int bumpLightHeight, int bumpLightValue, int lightValue, int darkValue, BufferedImage bumpBitmapEffectImage)
    {
        if (bumpBitmapEffectImage == null)
        {
            ...
            bumpBitmapImage = org.Kajeka.StaticLibraries.ImageProducer.cloneImage(bumpBitmapImage);
        ...
        else
        {
            ...
            bumpBitmapImage = org.Kajeka.StaticLibraries.ImageProducer.cloneImage(bumpBitmapEffectImage);
        ...
        if (USE_MULTICORE_PROCESS)
            bumpBitmapImageToReturn = org.Kajeka.StaticLibraries.ImageProducer.cloneImage(bumpBitmapImage);
    ...
    */
    private void radialBlurEffectInit(double radialBlurShortness, BufferedImage radialBlurEffectBitmapImage)
    {
        ...
        if (radialBlurEffectBitmapImage == null)
        {
            ...
            radialBlurBitmapImage = org.Kajeka.StaticLibraries.ImageProducer.cloneImage(radialBlurBitmapImage);
        ...
        else
        {
            ...
            radialBlurBitmapImage = org.Kajeka.StaticLibraries.ImageProducer.cloneImage(radialBlurEffectBitmapImage); // somehow, the Java API does a faster acceleration after using this method (using a predefined transparency and copying it)
        ...
        if (USE_MULTICORE_PROCESS)
            radialBlurBitmapImageToReturn = org.Kajeka.StaticLibraries.ImageProducer.cloneImage(radialBlurBitmapImage);
    ...
    */
    public void spotCircleEffectInit(int spotCircleWidth, int spotCircleHeight, int spotCircleCenterX, int spotCircleCenterY, int distStep, boolean withNoiseEffect, int distRatio)
    {
        ...
        distMAX = org.Kajeka.StaticLibraries.Math.findMinMaxFromNumbers(distMaxCornerTopLeft, distMaxCornerTopRight, distMaxCornerBottomLeft, distMaxCornerBottomRight, false); // false for MAX distance!

...
public final class Glyphbombing3DTexture
{
    ...
    */
    public void initGlyphbombing3DTexture(GL2 gl, int textureUnit)
    {
        ...
        BufferedImage glyphImage = org.Kajeka.StaticLibraries.ImageProducer.cloneImage( texturesLoader.getImage(GLYPH_TEXTURE_NAME) );
        readPixels( org.Kajeka.StaticLibraries.ImageProducer.resizeImageByGivenRatio(glyphImage, (currentTexture2DSliceSize / (float)MAX_TEXTURE_2D_SLICE_SIZE), true) );

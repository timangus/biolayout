package org.Kajeka.StaticLibraries;
    ...
    */
    public static Texture getNullPointerTexture(boolean useAutoMipmapGeneration)
    {
        if (nullPointerTexture == null)
            nullPointerTexture = createTextureFromBufferedImage(org.Kajeka.StaticLibraries.ImageProducer.createNullPointerBufferedImage(), useAutoMipmapGeneration);

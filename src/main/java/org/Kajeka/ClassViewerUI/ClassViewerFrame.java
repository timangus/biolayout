...
public final class ClassViewerFrame extends JFrame implements ActionListener, ListSelectionListener, ChangeListener, ItemListener {
   ...
   * Initializes the Class Viewer if not already visible. If visible,
   * deiconifies the frame, maximizes and brings to the front.
   */
...
//                    }
  ...
  private void displayPValueChart() {
    // Update the UI
    btnExportTable.setVisible(false);
...
//        }
  ...
  /**
   * Process a light-weight thread using the Adapter technique to avoid any GUI
   * latencies with the JButton setEnabled() update.
   */

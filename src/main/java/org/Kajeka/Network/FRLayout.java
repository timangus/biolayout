...
import static org.Kajeka.StaticLibraries.FixedPointMath.*;
...
public final class FRLayout
{
    ...
    */
    private void initAllCachedDataStructures(Collection<Vertex> vertices)
    {
        ...
        long totalCalculationsNeeded = org.Kajeka.StaticLibraries.Math.totalTriangularMatrixCalculationsNeeded( (long)numberOfVertices );

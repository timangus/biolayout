...
import static org.Kajeka.DataStructures.StackDataStructureTypes.*;
import static org.Kajeka.Network.GraphmlLookUpmEPNTables.*;
...
public class GraphmlNetworkContainer
{
    ...
    private HashMap<String, org.Kajeka.DataStructures.Stack<float[]>> allUndoGraphmlMapCoordsStacksMap = null;
    private HashMap<String, org.Kajeka.DataStructures.Stack<float[]>> allRedoGraphmlMapCoordsStacksMap = null;
    ...
    */
    public boolean isEmptyUndoPointStack(GraphNode node)
    {
        ...
        {
            org.Kajeka.DataStructures.Stack<float[]> undoGraphmlMapCoordsStack = allUndoGraphmlMapCoordsStacksMap.get( node.getNodeName() );
    ...
    */
    public boolean isEmptyRedoPointStack(GraphNode node)
    {
        ...
        {
            org.Kajeka.DataStructures.Stack<float[]> redoGraphmlMapCoordsStack = allRedoGraphmlMapCoordsStacksMap.get( node.getNodeName() );
    ...
    */
    ...
    {
        if (allUndoGraphmlMapCoordsStacksMap == null)
            allUndoGraphmlMapCoordsStacksMap = new HashMap<String, org.Kajeka.DataStructures.Stack<float[]>>();
        org.Kajeka.DataStructures.Stack<float[]> undoGraphmlMapCoordsStack = allUndoGraphmlMapCoordsStacksMap.get( node.getNodeName() );

        if (undoGraphmlMapCoordsStack == null)
        {
            undoGraphmlMapCoordsStack = new org.Kajeka.DataStructures.Stack<float[]>(USE_LINKEDLIST);
    ...
    */
    ...
    {
        if (allRedoGraphmlMapCoordsStacksMap == null)
            allRedoGraphmlMapCoordsStacksMap = new HashMap<String, org.Kajeka.DataStructures.Stack<float[]>>();
        org.Kajeka.DataStructures.Stack<float[]> redoGraphmlMapCoordsStack = allRedoGraphmlMapCoordsStacksMap.get( node.getNodeName() );

        if (redoGraphmlMapCoordsStack == null)
        {
            redoGraphmlMapCoordsStack = new org.Kajeka.DataStructures.Stack<float[]>(USE_LINKEDLIST);

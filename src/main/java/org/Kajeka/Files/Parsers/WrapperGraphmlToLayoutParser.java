...
/**
*
* WrapperGraphmlToLayoutParser is the wrapper parser class used to connect the GraphML parsed xml data files with the main application.
*
* @see org.Kajeka.Files.Parsers.GraphmlParser
* @see org.Kajeka.DataStructures.Tuple6

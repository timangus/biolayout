package org.Kajeka.Files.Dialogs;
...
*
* @see org.Kajeka.Files.Dialogs.ImportSelectClassSetsDialog
...
public final class ImportClassSetsDialog extends JDialog implements ActionListener, CaretListener
{
    ...
    */
    ...
    private boolean checkSelectedDelimiterForRegularExpressionCompatibility()
    {
        ...
        {
            if (DEBUG_BUILD) org.Kajeka.DebugConsole.ConsoleOutput.println("PatternSyntaxException in checkSelectedDelimiterForRegularExpressionCompatibility():\n" + exc.getMessage());

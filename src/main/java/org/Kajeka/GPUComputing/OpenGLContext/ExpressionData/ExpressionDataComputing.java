package org.Kajeka.GPUComputing.OpenGLContext.ExpressionData;
...
public class ExpressionDataComputing extends OpenGLContext
{
    ...
    */
    private void expressionDataReportAndCalculateTextureSize(int maxTextureSize, int totalRows, int totalColumns)
    {
        ...
        long totalExpressionDataCalculationsNeeded = org.Kajeka.StaticLibraries.Math.totalTriangularMatrixCalculationsNeeded( (long)totalRows );
        ...
        if (textureParameters.textureFormat == GL_RGBA)
        {
            ...
            oneDimensionalExpressionDataConvertedTo2DSquareTextureSize = org.Kajeka.StaticLibraries.Math.getNextPowerOfTwo(oneDimensionalExpressionDataConvertedTo2DSquareTextureSize);
    ...
    */
    ...
    {
        int twoDimensionalExpressionDataConvertedTo2DSquareTextureSizeNextPowerOfTwo = org.Kajeka.StaticLibraries.Math.getNextPowerOfTwo(twoDimensionalExpressionDataConvertedTo2DSquareTextureSize);

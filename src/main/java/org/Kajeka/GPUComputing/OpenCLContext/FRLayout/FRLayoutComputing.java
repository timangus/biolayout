package org.Kajeka.GPUComputing.OpenCLContext.FRLayout;
...
import org.Kajeka.GPUComputing.OpenCLContext.*;
import org.Kajeka.Network.*;
import static java.lang.Math.*;
import static org.jocl.CL.*;
import static org.Kajeka.Network.FRLayout.*;
...
public class FRLayoutComputing extends OpenCLContext
{
    ...
    */
                                                       ...
                                                       IntBuffer cachedVertexNormalizedWeightIndicesToSkipBuffer, int numberOfVertices, int iterations, double errorThreshold, boolean useEdgeWeights)
    {
        ...
        numberOfVerticesNextPowerOfTwo = org.Kajeka.StaticLibraries.Math.getNextPowerOfTwo(numberOfVertices);
        if ( useIndices1DKernel = USE_INDICES_1D_KERNEL_WITH_ITERATIONS_FOR_OPENCL_GPU_COMPUTING_LAYOUT_CALCULATION.get() )
        {
            ...
            long totalFRLayoutCalculationsNeeded = org.Kajeka.StaticLibraries.Math.totalTriangularMatrixCalculationsNeeded( (long)numberOfVertices );

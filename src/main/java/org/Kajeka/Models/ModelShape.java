...
import static org.Kajeka.Models.ModelTypes.*;
...
*
* @see org.Kajeka.Models.ModelSettings
* @see org.Kajeka.Models.ModelRenderingStates
* @see org.Kajeka.Models.Lathe3D.Lathe3DShape
* @see org.Kajeka.Models.SuperQuadric.SuperQuadricShape
* @see org.Kajeka.Models.Loaders.OBJModelLoader.OBJModelLoader
...
public abstract class ModelShape
{
    ...
    */
    protected void disposeNonInterleavedBuffers(GL2 gl)
    {
        ...
        {
            // restore Vertex Array state, default is on in OpenGL renderer
            if (!modelSettings.usingTexCoords)
                gl.glEnableClientState(GL_TEXTURE_COORD_ARRAY);
            if (!modelSettings.usingNormals)
                gl.glEnableClientState(GL_NORMAL_ARRAY);
    ...
    */
    public void saveModelShapeOBJFile(FileWriter fileWriter, ModelTypes modelShapeType) throws IOException
    {
        if ( !modelShapeType.equals(OBJ_MODEL_LOADER_SHAPE) )
        {
            ...
            fileWriter.write("# Generated by " + DISPLAY_PRODUCT_NAME_AND_VERSION + " (" + DOMAIN_URL + ") from Model Shape Editor: " + fileType + "\n");
            fileWriter.write("\n");

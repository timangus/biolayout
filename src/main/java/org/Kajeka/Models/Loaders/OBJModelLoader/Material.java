...
public class Material
{
    ...
    */
    ...
    {
        texture = TextureProducer.createTextureFromBufferedImageAndDeleteOrigContext(org.Kajeka.StaticLibraries.ImageProducer.loadImageFromURL( getClass().getResource(textureFileName) ), true);
    }
